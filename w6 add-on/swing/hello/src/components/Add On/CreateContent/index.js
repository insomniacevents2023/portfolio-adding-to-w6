...
var contentArray = [
    ...
    {title: "Cast and Crew", content: <img src={kanye} alt='Guest Star Kanye West and Cast' height='300px' />, index:2},
    ...
    {title: "Rotten Tomatoes", content: <img src={rottentom} alt='Rotten Tomatoes Review' height='300px' />, index:4},
