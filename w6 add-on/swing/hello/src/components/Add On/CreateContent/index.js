...
var contentArray = [
    ...
    {title: "Cast and Crew", content: <img src='%PUBLIC_URL%/img/kanye.jpeg' alt='Guest Star Kanye West and Cast' height='300px' />, index:2},
    ...
    {title: "Rotten Tomatoes", content: <img src='%PUBLIC_URL%/img/rottentom.jpeg' alt='Rotten Tomatoes Review' height='300px' />, index:4},
